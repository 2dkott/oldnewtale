...
//        ).build(new File("build/dist"));
        ...
        new TeaCompiler(
            ...
            .addReflectionClass("games.rednblack.hyperrunner.component")
            .addReflectionClass("games.rednblack.hyperrunner.system")
            .addReflectionClass("games.rednblack.hyperrunner.script")
            .build(new File("build/dist"));
    }
}
